...
test.describe('Food & Beverage page', () => {

  test.beforeEach(async ({ page }) => {
    await page.goto('https://initgroup.com/businessarea/food-beverage/');
  ...
  test('Page load', async ({ page }) => {
    ...
    const foodBeveragePageTitle = await page.title();
    expect(foodBeveragePageTitle).toBe('Automation and IT solutions tailored to Food & Beverage - Init');
  });
