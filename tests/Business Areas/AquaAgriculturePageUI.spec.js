...
test.describe('Aqua & Agriculture page', () => {

  test.beforeEach(async ({ page }) => {
    await page.goto('https://initgroup.com/businessarea/aqua-agriculture/');
  ...
  test('Page load', async ({ page }) => {
    ...
    const aquaAgriculturePageTitle = await page.title();
    expect(aquaAgriculturePageTitle).toBe('IT and automation solutions tailored to Aqua & Agriculture - Init');
  });
