...
test.describe('Marine & Offshore page', () => {

  test.beforeEach(async ({ page }) => {
    await page.goto('https://initgroup.com/businessarea/marine-offshore/');
  ...
  test('Page load', async ({ page }) => {
    ...
    const marineOffshorePageTitle = await page.title();
    expect(marineOffshorePageTitle).toBe('Tailored IT and automation services for Marine & Offshore - Init');
  });
