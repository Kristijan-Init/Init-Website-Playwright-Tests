...
test.describe('Utility page', () => {
  ...
  test.beforeEach(async ({ page }) => {
    await page.goto('https://initgroup.com/businessarea/utility/');
  ...
  test('Page load', async ({ page }) => {
    ...
    const utilityPageTitle = await page.title();
    expect(utilityPageTitle).toBe('IndustriaI IT and automation services tailored to Utility - Init');
  });
