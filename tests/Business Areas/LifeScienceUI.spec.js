...
test.describe('Life Science page', () => {

  test.beforeEach(async ({ page }) => {
    await page.goto('https://initgroup.com/businessarea/life-science/');
  ...
  test('Page load', async ({ page }) => {
    ...
    const lifeSciencePageTitle = await page.title();
    expect(lifeSciencePageTitle).toBe('IT and automation solutions tailored to Life Science - Init');
  });
