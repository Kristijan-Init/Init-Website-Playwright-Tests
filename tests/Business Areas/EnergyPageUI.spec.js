...
test.describe('Energy page', () => {
  ...
  test.beforeEach(async ({ page }) => {
    await page.goto('https://initgroup.com/businessarea/energy/');
  ...
  test('Page load', async ({ page }) => {
    ...
    const energyPageTitle = await page.title();
    expect(energyPageTitle).toBe('IT and automation solutions tailored for the Energy sector - Init');
  });
