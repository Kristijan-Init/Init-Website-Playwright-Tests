...
test.describe('Manufacturing page', () => {
  ...
  test.beforeEach(async ({ page }) => {
    await page.goto('https://initgroup.com/businessarea/manufacturing/');
  ...
  test('Page load', async ({ page }) => {
    ...
    const manufacturingPageTitle = await page.title();
    expect(manufacturingPageTitle).toBe('Tailored IT and automation solutions for Manufacturing industry - Init');
  });
