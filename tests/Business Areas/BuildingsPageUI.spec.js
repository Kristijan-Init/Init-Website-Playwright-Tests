...
test.describe('Buildings page', () => {
  ...
  test.beforeEach(async ({ page }) => {
    await page.goto('https://initgroup.com/businessarea/buildings/');
  ...
  test('Page load', async ({ page }) => {
    ...
    const buildingsPageTitle = await page.title();
    expect(buildingsPageTitle).toBe('Advanced automation and IT solutions for Buildings - Init');
  });
