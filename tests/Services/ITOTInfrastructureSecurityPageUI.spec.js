...
test.describe('IT/OT Infrastructure and Security page', () => {

  test.beforeEach(async ({ page }) => {
    await page.goto('https://initgroup.com/service/it-ot-infrastructure-and-security/');
  ...
  test('Page load', async ({ page }) => {
    ...
    const infrastructureSecurityPageTitle = await page.title();
    expect(infrastructureSecurityPageTitle).toBe('IT/OT infrastructure & security - Keep your facilities & systems safe');
  });
  ...
  test('Infrastructure - button', async ({ page }) => {
    ...
    const InfrastructureWWDPage = page.getByText('Infrastructure').nth(8);
