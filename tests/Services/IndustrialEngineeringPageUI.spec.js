...
test.describe('Industrial Engineering page', () => {

  test.beforeEach(async ({ page }) => {
    await page.goto('https://initgroup.com/service/industrial-engineering/');
  ...
  test('Page load', async ({ page }) => {
    ...
    const industrialEngineeringPageTitle = await page.title();
    expect(industrialEngineeringPageTitle).toBe('Industrial engineering | Electrical, Mechanical & Process Design - Init');
  });
