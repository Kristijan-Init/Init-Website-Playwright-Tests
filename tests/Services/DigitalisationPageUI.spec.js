...
test.describe('Digitalisation page', () => {

  test.beforeEach(async ({ page }) => {
    await page.goto('https://initgroup.com/service/digitalisation/');
  ...
  test('Page load', async ({ page }) => {
    ...
    const digitalisationPageTitle = await page.title();
    expect(digitalisationPageTitle).toBe('Tailored services to help you on your digitalisation journey - Init');
  });
  ...
  test('Energy - button', async ({ page }) => {
    ...
    const EnergyWWDPage = page.getByText('Energy').nth(3);
  ...
  test('Manufacturing - button', async ({ page }) => {
    ...
    const ManufacturingWWDPage = page.getByText('Manufacturing').nth(3);
