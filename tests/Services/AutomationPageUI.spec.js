...
test.describe('Automation page', () => {
  ...
  test.beforeEach(async ({ page }) => {
    await page.goto('https://initgroup.com/service/automation-solutions/');
  ...
  test('Page load', async ({ page }) => {
    ...
    const automationPageTitle = await page.title();
    expect(automationPageTitle).toBe('Design and implementation of automation solutions - Init');
  });
